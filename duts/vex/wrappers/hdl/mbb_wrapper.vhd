...
entity mbb_wrapper is
  port (
    ...
    M_AXI_DP_0_arprot : out STD_LOGIC_VECTOR ( 2 downto 0 ):= (others=>'0');
    M_AXI_DP_0_arready : in STD_LOGIC;
    M_AXI_DP_0_arvalid : out STD_LOGIC;
    M_AXI_DP_0_awaddr : out STD_LOGIC_VECTOR ( 31 downto 0 );
    M_AXI_DP_0_awprot : out STD_LOGIC_VECTOR ( 2 downto 0 ):= (others=>'0');
...
architecture STRUCTURE of mbb_wrapper is
  ...
  end component axi4vex;
begin



mbb_i: component axi4vex
     port map (
      ...
      M_AXI_DC_0_arlock(0) => M_AXI_DC_0_arlock,
      ...
      M_AXI_DC_0_awlock(0) => M_AXI_DC_0_awlock,
