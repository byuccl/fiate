...
################################################################
# This is a generated script based on design: kronos
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net kronos_v_0_bus_axi [get_bd_intf_ports M_AXI_DP_0] [get_bd_intf_pins kronos_v_0/bus_axi]
  ...
  connect_bd_net -net rst_0_1 [get_bd_ports Reset_0] [get_bd_pins kronos_v_0/sys_rst]
  connect_bd_net -net sys_clk_0_1 [get_bd_ports Clk_0] [get_bd_pins kronos_v_0/sys_clk]
