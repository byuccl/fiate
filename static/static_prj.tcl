...
#
# static_prj_v001.tcl: Tcl script for re-creating project 'static_prj'
#
# Generated by Vivado on Mon Feb 22 14:18:31 -0700 2021
...
#
# 1. This project restoration tcl script (static_prj_v001.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "c:/xup/acorn/ex000/static/static_prj/static_prj.srcs/sources_1/bd/design_1/design_1.bd"
#    "c:/xup/acorn/ex000/static/static_prj/static_prj.srcs/sources_1/bd/design_1/ip/design_1_mig_7series_0_0/mig.prj"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/xup/acorn/ex000/static/static_prj/static_prj.srcs/sources_1/imports/src/hdl/design_1_wrapper.v"
#    "C:/xup/acorn/ex000/static/static_prj/static_prj.srcs/sources_1/imports/src/ip/design_1_mig_7series_0_0/mig.prj"
#    "C:/xup/acorn/ex000/static/static_prj/static_prj.srcs/constrs_1/imports/constrs/top.xdc"
#    "C:/xup/acorn/ex000/static/static_prj/static_prj.srcs/constrs_1/imports/constrs/early.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "static_prj"
...
set script_file "static_prj_v001.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/static_prj"]"
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/ip/design_1_mig_7series_0_0/mig.prj"] \
]
...
set file "design_1_mig_7series_0_0/mig.prj"
...
source ./bd/static_bd.tcl

update_compile_order -fileset sources_1
make_wrapper -files [get_files static_prj/static_prj.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse static_prj/static_prj.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v
update_compile_order -fileset sources_1
...
set file "[file normalize ${origin_dir}/constrs/top.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constrs/top.xdc"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/constrs/early.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constrs/early.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "target_constrs_file" -value "${origin_dir}/constrs/top.xdc" -objects $obj
set_property -name "target_part" -value "xc7a200tfbg484-3" -objects $obj
set_property -name "target_ucf" -value "${origin_dir}/constrs/top.xdc" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a200tfbg484-3 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
#generate_target all [get_files  static_prj/static_prj.srcs/sources_1/bd/design_1/design_1.bd]
...
write_checkpoint -force ../bld/static/static.dcp
