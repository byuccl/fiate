# Runtime Tcl commands to interact with - bb_ip_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/bb_ip_v1_0_include.tcl
...
# Test: M_AXI_DP_0
set wdata_m_axi_dp_0 [get_init_data 0]
create_hw_axi_txn w_m_axi_dp_0_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m_axi_dp_0}
create_hw_axi_txn r_m_axi_dp_0_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m_axi_dp_0_addr
run_hw_axi w_m_axi_dp_0_addr
run_hw_axi r_m_axi_dp_0_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m_axi_dp_0_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 3 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M_AXI_DP_0"
} else {
	puts "Data comparison test fail for - M_AXI_DP_0, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}

# Test: M_AXI_DC_0
set wdata_m_axi_dc_0 [get_init_data 1]
create_hw_axi_txn w_m_axi_dc_0_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m_axi_dc_0}
create_hw_axi_txn r_m_axi_dc_0_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m_axi_dc_0_addr
run_hw_axi w_m_axi_dc_0_addr
run_hw_axi r_m_axi_dc_0_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m_axi_dc_0_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 3 1 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M_AXI_DC_0"
} else {
	puts "Data comparison test fail for - M_AXI_DC_0, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}

# Test: M_AXI_IC_0
set wdata_m_axi_ic_0 [get_init_data 2]
create_hw_axi_txn w_m_axi_ic_0_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m_axi_ic_0}
create_hw_axi_txn r_m_axi_ic_0_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m_axi_ic_0_addr
run_hw_axi w_m_axi_ic_0_addr
run_hw_axi r_m_axi_ic_0_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m_axi_ic_0_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 3 2 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M_AXI_IC_0"
} else {
	puts "Data comparison test fail for - M_AXI_IC_0, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
